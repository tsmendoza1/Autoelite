...
('Juan', 'Pérez', 'juan.perez@email.com', '+34 612 345 678', 'Calle Mayor 123, Madrid'),
('María', 'García', 'maria.garcia@email.com', '+34 623 456 789', 'Avenida Libertad 45, Barcelona'),
('Carlos', 'Rodríguez', 'carlos.rodriguez@email.com', '+34 634 567 890', 'Plaza España 7, Valencia'),
('Ana', 'Martínez', 'ana.martinez@email.com', '+34 645 678 901', 'Calle Sol 89, Sevilla'),
('Luis', 'López', 'luis.lopez@email.com', '+34 656 789 012', 'Avenida Constitución 12, Bilbao');
...
INSERT INTO reservas (cliente_id, auto_id, fecha_inicio, fecha_fin, estado, notas) VALUES
(1, 4, '2024-01-15', '2024-01-20', 'Confirmada', 'Cliente requiere seguro completo'),
...
(4, 6, '2024-02-01', '2024-02-05', 'Confirmada', 'Cliente solicita entrega a domicilio');
